...
Function Input/Parameters: c-style source string (char *)
Fucntion Output/Parameters: c-style destination string (char *)
    ...
    if( destStr != sourceStr )
       {
        ...
        while( sourceStr[ index ] != NULL_CHAR && index < MAX_STR_LEN )
           {
            // assign to end of source string
...
Function Output/Parametrs: none
    ...
    while( masterIndex < testStrLen )
       {
        ...
        // set internel search index to zero
        searchIndex = 0;
        ...
        while( internalIndex <= testStrLen
                     && testStr[ internalIndex ] == searchSubStr[ searchIndex ] )
           {
            ...
            if( searchSubStr[ searchIndex ] == NULL_CHAR )
               {
                // return beginning locattion of sub string
                return masterIndex;
               }
           }
        // end internel comparison loop
